...
interface MenuItem {
  icon: LucideIcon | React.ComponentType<React.ComponentPropsWithoutRef<"svg">>
  label: string
  href: string
  gradient: string
  iconColor: string
...
export const MenuBar = React.forwardRef<HTMLElement, MenuBarProps>(
  ({ className, items, activeItem, onItemClick, id, style }, ref) => {
            ...
            return (
              <motion.li key={item.label} className="relative">
                <button
                  ...
                  className="block w-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-xl"
                >
                  <motion.div
